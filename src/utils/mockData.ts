...
export const mockCampusGeneralPosts: Post[] = [
  {
    ...
    chatroomName: "Economics Class Discussion",
  ...
  },
  {
    ...
    chatroomName: "Campus Library Updates",
  ...
  },
  {
    ...
    chatroomName: "Calculus III Study Group",
    channelType: "CampusGeneral",
    category: "Study",
  ...
  },
  {
    ...
    chatroomName: "Biology Class Updates",
    channelType: "CampusGeneral",
    category: "Study",
...
export const mockForumPosts: Post[] = [
  {
    ...
    chatroomName: "Study Techniques Discussion",
    channelType: "Forum",
    category: "Study",
  ...
  },
  {
    ...
    chatroomName: "Coffee Shop Recommendations",
    channelType: "Forum",
  ...
  },
  {
    ...
    chatroomName: "Homework Support Group",
    channelType: "Forum",
    category: "Drama",
  ...
  },
  {
    ...
    chatroomName: "Online Learning Resources",
    channelType: "Forum",
    category: "Study",
  ...
  },
  {
    ...
    chatroomName: "Research Projects",
    channelType: "Forum",
...
export const mockCampusCommunityPosts: Post[] = [
  {
    ...
    university: "TDTU University",
    chatroomName: "CS 101 Study Group",
  ...
  },
  {
    ...
    university: "TDTU University",
    chatroomName: "Campus Clean-up Event",
    channelType: "CampusCommunity",
    category: "Other",
  ...
  },
  {
    ...
    university: "TDTU University",
    chatroomName: "Textbook Exchange",
    channelType: "CampusCommunity",
    category: "Study",
...
export const mockCommunityPosts: Post[] = [
  {
    ...
    university: "All",
    chatroomName: "Travel Tips & Recommendations",
  ...
  },
  {
    ...
    university: "All",
    chatroomName: "Internship Networking",
    channelType: "Community",
    category: "Study",
  ...
  },
  {
    ...
    university: "All",
    chatroomName: "Basketball Meetup",
    channelType: "Community",
    category: "Fun",
  ...
  },
  {
    ...
    university: "All",
    chatroomName: "Sustainable Energy Research",
    channelType: "Community",
    category: "Study",
...
export const mockChatRooms: ChatRoom[] = [
  {
    ...
    postId: "post-cg-1",
    chatroomName: "Economics Class Discussion",
    chatroomPhoto: "https://i.pravatar.cc/150?img=1",
    participants: [
  ...
  },
  {
    ...
    postId: "post-forum-1",
    chatroomName: "Study Techniques Discussion",
    chatroomPhoto: "https://i.pravatar.cc/150?img=3",
    participants: [
  ...
  },
  {
    ...
    postId: "post-cg-2",
    chatroomName: "Campus Library Updates",
    chatroomPhoto: "https://i.pravatar.cc/150?img=5",
    participants: [
      mockUsers.find(u => u.id === "user-2")!,
      mockUsers.find(u => u.id === "user-1")!,
      mockUsers.find(u => u.id === "user-5")!
